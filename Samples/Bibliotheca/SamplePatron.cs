...
namespace Primus.Sample.Bibliotheca
{
    public class SamplePatron : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            GameObject myNewObject = SampleBibliothecaOwnerSingleton.Instance.Bibliotheca.CheckOut(SampleTitleCatalog.Cylinder);
            if (myNewObject != null)
            {
                ...
                SampleBiblionCylinder myNewCylinder = myNewObject.GetComponent<SampleBiblionCylinder>();
